...
// MARK: - Properties
    ...
    private let viewModel: ViewModelProfileProtocol = ProfileModel()
    let servis: ServiseProtocol = Servise()
    let netWork: NetWorkProtocol = NetWork()
    let viewModelRouter: ViewModelProfile
...
// MARK: - init
    init(viewModelRouter: ViewModelProfile) {
...
// MARK: - showInfoProfile
    private func showInfoProfile() {
            netWork.showInfoProfile(completion: { dataFiles in
...
//            viewModelRouter.noPublishedFiles()
